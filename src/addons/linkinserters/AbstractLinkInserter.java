...
/**
 * Implements the insertion of one link in the topology.
 */
public abstract class AbstractLinkInserter implements LinkInserter {

    /**
     * Inserts one link into the given topology. If one of the nodes of the link does not exist in the topology
