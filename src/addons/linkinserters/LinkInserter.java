...
/**
 * A link inserter inserts new links into a core.topology.
 */
public interface LinkInserter {

    /**
     * Inserts any link into the given core.topology. The insertion of the link may depend on the current time depending on
