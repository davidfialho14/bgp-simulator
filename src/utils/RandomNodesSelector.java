...
/**
 * Randomly selects a subset of nodes from a topology. Once a node is selected, in the next selection it can not be
 * selected again.
 */
public class RandomNodesSelector {
    ...
    /**
     * Randomly selects nodeCount nodes from the set of nodes in the topology associated with this selector.
