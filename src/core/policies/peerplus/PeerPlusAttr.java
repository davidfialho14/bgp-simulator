 ...
 */
public class PeerPlusAttr implements Attribute {
    ...
    private static final Attribute SELF = new PeerPlusAttr(Value.Self);
    private static final Attribute PEERPLUS = new PeerPlusAttr(Value.Customer);
    private static final Attribute CUSTOMER = new PeerPlusAttr(Value.Customer);
    private static final Attribute PEER = new PeerPlusAttr(Value.Peer);
    private static final Attribute PROVIDER = new PeerPlusAttr(Value.Provider);

    // use the factory methods to create each attribute instance
    private PeerPlusAttr(Value value) {
        this.value = value;
    }
    ...
    public int compareTo(Attribute attribute) {
        ...
        PeerPlusAttr other = (PeerPlusAttr) attribute;
        return value.compareTo(other.value);
    }

    @Override
    public boolean equals(Object other) {
        if (!(other instanceof PeerPlusAttr)) return false;

        PeerPlusAttr otherAttribute = (PeerPlusAttr) other;
