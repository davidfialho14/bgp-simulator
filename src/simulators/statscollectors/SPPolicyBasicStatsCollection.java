...
/**
 * Stats collection for the shortest path policy. It introduces extra stats that only make sense for this policy.
 *  - false positive count
 */
public class SPPolicyBasicStatsCollection extends BasicStatsCollection {
     ...
     */
    public SPPolicyBasicStatsCollection(int nodeCount, int linkCount) {
