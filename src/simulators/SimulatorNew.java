...
import io.reporters.ReporterNew;
...
public class SimulatorNew {
    ...
    private File reportDestination = ReporterNew.REPORT_DIRECTORY;

    public SimulatorNew(TopologyReaderFactory readerFactory, File topologyFile, int minDelay, int maxDelay,
